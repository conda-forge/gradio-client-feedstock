...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/gradio-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gradio-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add gradio-client
# for installing globally
pixi global install gradio-client
```
...
It is possible to list all of the versions of `gradio-client` available on your platform:
...
```
pixi search gradio-client --channel conda-forge
```
